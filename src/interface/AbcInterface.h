...
class AbcInterface
{
    public:
        ...
        float balance(bool l = false, bool d = false, bool s = false, bool x = false);
        ...
        /// @return time taken. -1 if failed
        float resub(IntType k = -1, IntType n = -1, IntType f = -1, bool l = false, bool z = false);
        ...
        /// @return time taken. -1 if failed
        float rewrite(bool l = false, bool z = false);
